...
{
    public class ExpertiseEstimationModel
    {
        ...
        public List<TbrubriqueEstimationDto> RubriqueEstimations { get; set; }

        public List<TbexpertiseRubriqueEstimationDto> expertiseRubriqueEstimations { get; set; }
